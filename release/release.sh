...
export DOCKERHUB_BUILDKIT_IMG=${DOCKERHUB_IMG:-buildkitd}
...
"$earthly" --push --build-arg DOCKERHUB_USER --build-arg DOCKERHUB_IMG --build-arg RELEASE_TAG --build-arg PRERELEASE +release-dockerhub
